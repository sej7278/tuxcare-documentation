...
Essential Support customers can upgrade to a new minor version, for example from 9.2 to 9.5 by editing the /etc/dnf/vars/tuxcare_releasever file to specify the new version, like so:
